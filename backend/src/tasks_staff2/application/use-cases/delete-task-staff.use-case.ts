import {
  ...
  import { DeleteTaskStaffInput } from 'src/tasks_staff2/domain/interfaces/delete-task-staff.input';
  import { TaskStaffRepositoryPort } from '../../domain/ports/task-staff.repository.port';
  import { TaskStaffMapper } from 'src/tasks_staff2/infrastructure/mappers/task-staff.mapper';
